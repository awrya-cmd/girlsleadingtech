            ...
            <div className="flex flex-col-reverse md:flex-row items-center md:items-stretch justify-between gap-8 md:gap-12 relative z-10">
              ...
              <div className="flex-1 text-center md:text-left flex flex-col justify-center animate-fade-up">
                ...
                <h1 className="font-sans text-4xl sm:text-5xl md:text-6xl font-bold text-gray-900 leading-tight tracking-tight">
                  Build. <span className="italic font-medium text-[#5b2b4a] font-serif">Win.</span> Repeat.
                </h1>
                <p className="mt-4 max-w-xl text-sm md:text-base leading-relaxed text-muted-foreground">
                  {hackathons.length} hackathons and coding challenges hand-picked for women in tech.
                </p>
              </div>
              
              {/* Layout Spacer on Desktop to prevent overlapping of text and mascot */}
            ...
            >
              ...
              >
                <div>
                  ...
                  <span className="mt-2.5 inline-block rounded-full bg-purple-100 text-purple-700 px-2.5 py-0.5 text-[11px] font-semibold">
                    {h.organisedBy}
                  </span>
                  ...
                  <div className="mt-4 space-y-3 text-[13px]">
                    <div className="flex items-start gap-2.5">
                      ...
                      <div>
                        <p className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground" style={{ fontFamily: "'Montserrat', sans-serif" }}>Benefits & Prizes</p>
                        <p className="mt-0.5 text-foreground/80 font-medium leading-tight">{h.benefit}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-2.5">
                      ...
                      <div>
                        ...
                        <p className="mt-0.5 text-muted-foreground font-medium leading-tight">{h.eligibility}</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-6">
                  <div className="flex flex-wrap gap-2 pt-2">
                    <span className="inline-flex items-center gap-1 rounded-lg bg-white/95 border border-gray-100 px-2.5 py-1 text-[11px] font-semibold text-gray-700 shadow-xs">
                      <Clock className="h-3 w-3 text-[#d955a4]" /> {h.duration}
                    </span>
                    <span className="inline-flex items-center gap-1 rounded-lg bg-white/95 border border-gray-100 px-2.5 py-1 text-[11px] font-semibold text-gray-700 shadow-xs">
                      <Calendar className="h-3 w-3 text-secondary" /> {h.openDate}
                    </span>
                  </div>
